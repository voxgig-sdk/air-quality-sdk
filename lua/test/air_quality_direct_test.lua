...
describe("AirQualityDirect", function()
  it("should direct-load-air_quality", function()
    local setup = air_quality_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-air_quality", setup.live and "live" or "unit")
...
function air_quality_direct_setup(mockres)
