...
class AirQualityTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AirQualityTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AirQualityTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AirQualityTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
