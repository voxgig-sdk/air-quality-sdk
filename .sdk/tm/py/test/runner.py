...
class AirQualityTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AirQualityTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AirQualityTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AirQualityTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
