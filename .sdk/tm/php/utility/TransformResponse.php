...
// AirQuality SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AirQualityTransformResponse
{
    public static function call(AirQualityContext $ctx): mixed
    {
        ...
        $transform = AirQualityHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
