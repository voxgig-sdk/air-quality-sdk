...
// AirQuality SDK idempotency feature
...
class AirQualityIdempotencyFeature extends AirQualityBaseFeature
{
    ...
    private function _mutating(AirQualityContext $ctx): bool
    {
