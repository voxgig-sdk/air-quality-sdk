...
// AirQuality SDK ratelimit feature
...
class AirQualityRatelimitFeature extends AirQualityBaseFeature
{
    ...
    private function _acquire(AirQualityContext $ctx): void
    {
    ...
    private function _track(AirQualityContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
