...
class AirQualityNetsimFeature extends AirQualityBaseFeature
{
    ...
    private function _simulate(AirQualityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AirQualityContext $ctx, array $applied): void
    {
        $client = $this->client;
