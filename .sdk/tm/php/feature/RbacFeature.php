...
class AirQualityRbacFeature extends AirQualityBaseFeature
{
    ...
    private function _required(AirQualityContext $ctx): ?string
    {
    ...
    private function _reject(AirQualityContext $ctx, string $required): void
    {
    ...
    private function _track(AirQualityContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
