...
// AirQuality SDK telemetry feature
...
class AirQualityTelemetryFeature extends AirQualityBaseFeature
{
    ...
    private function _close(AirQualityContext $ctx, bool $ok): void
    {
