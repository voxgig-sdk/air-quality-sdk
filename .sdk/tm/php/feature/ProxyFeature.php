...
class AirQualityProxyFeature extends AirQualityBaseFeature
{
    ...
    public function init(AirQualityContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AirQualityContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
