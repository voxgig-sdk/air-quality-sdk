...
describe('exists', async () => {
  ...
  //
  // AirQualitySDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof AirQualitySDK, true,
      'AirQualitySDK.test() must return a client synchronously')
  })
