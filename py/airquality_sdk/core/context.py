...
from airquality_sdk.core.control import AirQualityControl
...
from airquality_sdk.core.helpers import get_ctx_prop, to_map
...
class AirQualityContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, AirQualitySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AirQualityResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AirQualityResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AirQualityError(code, msg, self)
