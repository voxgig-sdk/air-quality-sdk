# AirQuality SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, AirQualityError):
        errmsg = err.msg
    ...
    msg = "AirQualitySDK: " + opname + ": " + errmsg
    ...
    sdk_err = AirQualityError("", msg, ctx)
