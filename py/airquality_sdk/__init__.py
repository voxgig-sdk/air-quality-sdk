...
from airquality_sdk.utility import register

# Load features
from airquality_sdk.feature.base_feature import AirQualityBaseFeature
from airquality_sdk.features import _has_feature, _make_feature
...
class AirQualitySDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AirQualityUtility()
        self._utility = utility

        from airquality_sdk.config import shared_config
    ...
    def get_utility(self):
        return AirQualityUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AirQualitySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def AirQuality(self, data=None) -> "AirQualityEntity":
        ...
        from airquality_sdk.entity.air_quality_entity import AirQualityEntity
