# AirQuality SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AirQualitySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AirQualitySDK(...) and AirQualitySDK.test(...) become
#      AirQualitySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "airquality_sdk"
_SDK_CLASS = "AirQualitySDK"
