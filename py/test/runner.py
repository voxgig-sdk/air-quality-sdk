...
class AirQualityTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AirQualityTestRunner.getenv("AIRQUALITY_TEST_LIVE")
        override = AirQualityTestRunner.getenv("AIRQUALITY_TEST_OVERRIDE")
        ...
        explain = AirQualityTestRunner.getenv("AIRQUALITY_TEST_EXPLAIN")
