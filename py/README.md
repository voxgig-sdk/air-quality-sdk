# AirQuality Python SDK



The Python SDK for the AirQuality API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.AirQuality()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/air-quality-sdk/releases)) or
...
```
py/
├── airquality_sdk.py         -- Main SDK module
