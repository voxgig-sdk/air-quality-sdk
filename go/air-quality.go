...
// instead of `sdk.NewAirQualitySDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AirQualitySDK  { return NewAirQualitySDK(nil) }
func Test() *AirQualitySDK { return TestSDK(nil, nil) }
