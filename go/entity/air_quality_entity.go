...
type AirQualityEntity struct {
	name    string
	client  *core.AirQualitySDK
...
func NewAirQualityEntity(client *core.AirQualitySDK, entopts map[string]any) *AirQualityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AirQualityEntity) GetName() string { return e.name }
...
func (e *AirQualityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AirQualityEntity) Deleted() bool {
	return e.deleted
}


func (e *AirQualityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAirQualityEntity(e.client, opts)
}

func (e *AirQualityEntity) Data(args ...any) any {
...
func (e *AirQualityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AirQuality; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AirQualityEntity) DataTyped(data ...AirQuality) AirQuality {
	if len(data) > 0 {
		return typedFrom[AirQuality](e.Data(asMap(data[0])))
	}
	return typedFrom[AirQuality](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AirQuality (all fields
// optional at the wire level).
func (e *AirQualityEntity) MatchTyped(match ...AirQuality) AirQuality {
	if len(match) > 0 {
		return typedFrom[AirQuality](e.Match(asMap(match[0])))
	}
	return typedFrom[AirQuality](e.Match())
}
...
func (e *AirQualityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AirQualityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AirQualityLoadMatch and returns an AirQuality. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AirQualityEntity) LoadTyped(reqmatch AirQualityLoadMatch, ctrl map[string]any) (AirQuality, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AirQuality{}, err
	}
	return typedFrom[AirQuality](res), nil
}



func (e *AirQualityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AirQualityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AirQualityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AirQualityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AirQualityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
