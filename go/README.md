...
The Golang SDK for the AirQuality API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/air-quality-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/air-quality-sdk=../path/to/github.com/voxgig-sdk/air-quality-sdk
```
...
```
github.com/voxgig-sdk/air-quality-sdk/
...
The root package (`github.com/voxgig-sdk/air-quality-sdk`) re-exports everything needed
