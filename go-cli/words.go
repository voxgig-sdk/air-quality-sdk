...
func registerSDKWords(r *eng.Registry, client *sdk.AirQualitySDK) {
...
func runOp(client *sdk.AirQualitySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
