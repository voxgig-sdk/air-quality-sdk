...
AQL-driven CLI and REPL for the AirQuality SDK. Positional arguments are
...
./air-quality-cli list air_quality
./air-quality-cli load 1 air_quality
./air-quality-cli load '{id:1}' air_quality
