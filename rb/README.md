...
The Ruby SDK for the AirQuality API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `AirQualityError` (a `StandardError` subclass), so wrap
...
```
rb/
├── AirQuality_sdk.rb       -- Main SDK module
...
The main module (`AirQuality_sdk`) exports the SDK class
