...
// AirQuality SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AirQualityTestFeature extends AirQualityBaseFeature
{
    ...
    public function init(AirQualityContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AirQualityContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AirQualityParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AirQualityContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AirQualityContext $ctx, $op, $args): array
    {
