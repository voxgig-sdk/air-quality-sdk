...
// AirQuality SDK streaming feature
...
class AirQualityStreamingFeature extends AirQualityBaseFeature
{
    ...
    private function _iterate(AirQualityResult $result): \Generator
    {
    ...
    private function _streamable(AirQualityContext $ctx): bool
    {
