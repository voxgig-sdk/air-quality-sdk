...
class AirQualityCacheFeature extends AirQualityBaseFeature
{
    ...
    private function _through(AirQualityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
