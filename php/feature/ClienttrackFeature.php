...
// AirQuality SDK clienttrack feature
...
class AirQualityClienttrackFeature extends AirQualityBaseFeature
{
    ...
    public function PostConstruct(AirQualityContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AirQuality-SDK';
