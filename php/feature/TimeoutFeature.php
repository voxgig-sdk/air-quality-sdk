...
// AirQuality SDK timeout feature
...
class AirQualityTimeoutFeature extends AirQualityBaseFeature
{
    ...
    private function _with_timeout(AirQualityContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AirQualityContext $_ctx, float $ms): void
    {
        $client = $this->client;
