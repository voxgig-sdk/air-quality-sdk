...
// AirQuality SDK utility: fetcher
...
class AirQualityFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AirQualitySDK/1.0)';
    ...
    public static function call(AirQualityContext $ctx, string $fullurl, array $fetchdef): array
    {
