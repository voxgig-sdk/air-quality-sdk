...
// AirQuality SDK utility: graphql
//
...
class AirQualityGraphql
{
    ...
    // equivalent.
    public static function body(AirQualityContext $ctx): mixed
    {
    ...
    public static function errors(AirQualityContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
