...
class AirQualityTestRunner
{
    ...
    {
        $live = self::getenv('AIR_QUALITY_TEST_LIVE');
        $override = self::getenv('AIR_QUALITY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AIR_QUALITY_TEST_EXPLAIN');
...
class_alias('AirQualityTestRunner', 'Runner');
class_alias('AirQualityHelpers', 'Helpers');
