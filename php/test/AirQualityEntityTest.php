...
class AirQualityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set AIRQUALITY_TEST_AIR_QUALITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function air_quality_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("AIRQUALITY_TEST_AIR_QUALITY_ENTID");
