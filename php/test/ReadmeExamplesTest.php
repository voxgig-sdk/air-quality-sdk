...
// AirQuality SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AirQualitySDK::test)
...
{
    private const SDK_CLASS = 'AirQualitySDK';
    ...
    private const SDK_BASE = 'airquality_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../airquality_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
