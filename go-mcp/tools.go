...
type Args struct {
	Entity string         `json:"entity" jsonschema:"air_quality"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AirQualitySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "air-quality_list",
		Description: "List records from AirQuality. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "air-quality_load",
		Description: "Load a single record from AirQuality. " +
...
func runOp(client *sdk.AirQualitySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AirQualitySDK, name string) (sdk.AirQualityEntity, error) {
	switch strings.ToLower(name) {
	case "air_quality":
		return client.AirQuality(nil), nil
