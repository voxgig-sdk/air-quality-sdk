// Command AirQuality-mcp is an MCP server exposing the AirQuality
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AirQuality_list  — list records of an entity
//	AirQuality_load  — load a single record of an entity
//
